...
=======
        ...
        populateAutoComplete();
>>>>>>> 6bb0c098f662445188613c35df69159ff738fa5c
...
//    }
    ...
    public void RequestUserProfile(RequestQueue queue) {
        ...
        String url = PROFILE_STRING + "user=" + mEmail + "&password=" + mPassword;
    ...
    public void login(String email, String password) {
        ...
        mEmail = email;
        mPassword = password;
        mLogin = LOGIN_STRING + "user=" + mEmail + "&password=" + mPassword;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                Request.Method.GET, mLogin, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                System.out.println(jsonObject.toString());
                try {
