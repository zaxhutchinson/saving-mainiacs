...
if ( isset_input_list($lInput) ) {
    ...
    //$lResult = $db->select_table(["ActiveQuests"], $lFields, ["UserID","Completed","Rewarded"], [$lUserID,"1","0"]);  
    ...
    $lResult = $db->select_table(["Charity","QuestType", "ActiveQuests"], $lFields, ["QuestType.CharityID","QuestType.QuestID", "UserID","Completed","Rewarded"], ["Charity.CharityID","ActiveQuests.QuestID", $lUserID,"1","0"]);  
